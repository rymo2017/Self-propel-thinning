...
contains
    ...
    pure function bessel1(x) result(l)
        implicit none
        ...
        REAL(8) :: Y,P1,P2,P3,P4,P5,P6,R1,R2,R3,R4,R5,R6,Q1,Q2,Q3,Q4,Q5,S1,S2,S3,S4,S5,S6
        ...
        if( ax < 8.d0 ) then
            ...
            l = SQRT(P6/AX)*(COS(XX)*FP-Z*SIN(XX)*FQ)*SIGN(S6,X)
        endif
    end function
